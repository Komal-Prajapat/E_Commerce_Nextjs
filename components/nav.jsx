...
<div
      ...
      <div className="sticky top-0 flex flex-col md:flex-row justify-around bg-white shadow-2xl mb-6 w-[100%] z-10">
        <div className="m-3">
        ...
        <div>
          <ul className="flex justify-center items-center">
            ...
            <Link href={"/laptop"}>
              <li className="p-3  text-black hover:bg-black hover:text-white hover:cursor-pointer mr-32">
                Laptops
              </li>
            </Link>
          </ul>
        ...
        >
          ...
          {dropdown && (
            <div
              onMouseOver={() => setDropdown(true)}
              onMouseLeave={() => setDropdown(false)}
              className="absolute right-8 bg-white top-9 rounded-md px-5 w-36 py-5 text-center"
            >
              <ul>
                <Link href={"/myaccount"}>
                  {" "}
                  <li className="py-1 text-black text-md font-bold hover:bg-gray-600 hover:text-white">
                    My Account
                  </li>{" "}
                </Link>
                <Link href={"/orders"}>
                ...
                <li
                  onClick={logout}
                  className="py-1 text-black text-md font-bold hover:bg-gray-600 hover:text-white"
                >
                  Logout
                </li>
              </ul>
