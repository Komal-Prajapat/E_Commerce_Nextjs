        ...
        <div className="container px-5 pt-16 pb-14 mx-auto">
          <div className="flex flex-wrap md:text-left text-center order-first">
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 className="title-font font-medium tracking-widest text-sm text-white mb-3">
                MOBILES
              </h2>
              <nav className="list-none mb-10">
                <li>
                  ...
                  <Link
                    className="hover:border-b-2 text-white border-black"
                    href="/mi"
                  >
                    MI
                  </Link>
                ...
                <li>
                  <a className="text-gray-600 text-white hover:text-gray-800"></a>
                  <Link
                    className="hover:border-b-2 text-white border-black"
                    href="/samsung"
                  >
              ...
              <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
                <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                  <label
                    ...
                    className="leading-7 text-sm text-white text-gray-600"
                  >
                    Feedback
                  </label>
                  <input
